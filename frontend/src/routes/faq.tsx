  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "The goal is to maximize your probability of choosing the single best property available to you — not just finding a good one. Without a strategy, buyers face two failure modes: committing too early (settling for a mediocre property before seeing better options) or waiting too long (passing on the best property while holding out for something that never comes). The Buying Plan resolves this tension using optimal stopping theory. By spending roughly the first 37% of your search gathering data without committing, then committing to the first property that beats everything in that exploration window, you maximize the mathematical probability of landing your best realistic option. The trade-off is discipline: you must follow the rule even when a property in the explore phase feels great, and commit promptly once the threshold is crossed.",
      },
      {
