...
from agent.tools.ba_value_drivers import prefetch_bart_stations, prefetch_caltrain_stations, prefetch_muni_stops
...
async def run_prefetch(force: bool = False) -> dict:
    market, fhfa, zillow, hazards, bart, caltrain, muni = await asyncio.gather(
